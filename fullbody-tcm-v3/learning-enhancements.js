...
export function initLearningEnhancements(ctx) {
 ...
 function focusPoint(pos){setRegion('body',false);ctx.focusBounds(new THREE.Box3(pos.clone().addScalar(-85),pos.clone().addScalar(85)));}
