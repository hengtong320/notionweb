const CACHE='jigsaw-drop-h5-v3.5.1';
const CORE=['./','./index.html','./style.css?v=3.5.1','./game.js?v=3.5.1','./manifest.webmanifest?v=3.5.1','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
