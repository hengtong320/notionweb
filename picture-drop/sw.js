const CACHE='jigsaw-drop-h5-v3.9.0';
const CORE=['./','./index.html','./style.css?v=3.9.0','./game.js?v=3.9.0','./manifest.webmanifest?v=3.9.0','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
