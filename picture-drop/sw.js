const CACHE='jigsaw-drop-h5-v4.0.0';
const CORE=['./','./index.html','./style.css?v=4.0.0','./game.js?v=4.0.0','./manifest.webmanifest?v=4.0.0','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
