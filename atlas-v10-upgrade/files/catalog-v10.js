...
const EXACT={GV14:{pinyin:'dà zhuī',spokenText:'大锥'},GV28:{pinyin:'yín jiāo',spokenText:'银交'},BL2:{pinyin:'cuán zhú',spokenText:'全竹'},PC4:{pinyin:'xì mén',spokenText:'隙门'},HT6:{pinyin:'yīn xì',spokenText:'阴隙'},BL38:{pinyin:'fú xì',spokenText:'浮隙'},LR5:{pinyin:'lǐ gōu',spokenText:'里沟'},CV17:{pinyin:'dàn zhōng',spokenText:'淡中'},KI27:{pinyin:'shū fǔ',spokenText:'书府'}};
const ALL={};
...
export const BY_ID=Object.fromEntries(BONES.map(b=>[b.id,b]));
